...
<? //Шаблон детальной родительского товара для шин и дисков ?>
...
<div class="product-support">
    <ul class="markers">
        ...
        <li>
            <a href="#"><?=GetMessage("RECOMMENDED_TAB_TITLE")?></a>
        </li>
        <li>
            <a href="#"><?=GetMessage("ASK_QUESTION_TAB_TITLE")?></a>
        </li>
    </ul>
        ...
        <table class="size-table tire">
            ...
            <? foreach($arResult["CUSTOM_OFFERS"] as $diameterValue => $arOffers):?>
                ...
                <? foreach($arOffers as $arOffer):?>
                    <? 
                        $messageFullTextSize = array();
                        foreach($FULL_TEXT_SIZE as $fullTextSizeValue) {
                            $messageFullTextSize[$fullTextSizeValue] =  $arOffer["PROPERTIES"][$fullTextSizeValue]["VALUE"];
                        }
                    ?>
                    <tr id="product" class="offer_block" data-page="<?=$count?>">
                        <td class="size">
                            <a href="<?=$arOffer["DETAIL_PAGE_URL"]?>">
                                <?=GetMessage("FULL_TEXT_SIZE", $messageFullTextSize); ?>
                            </a>
                        </td>
                        <td class="article">
