                    ...
                    <? foreach($arOffers as $arOffer):?>
                        <tr id="product" class="offer_block" data-page="<?=$count?>">
                          <td class="size"><a href="<?=$arOffer["DETAIL_PAGE_URL"]?>"><?=GetMessage("FULL_TEXT_SIZE", array(
                            "DIAMETR_1" => $arOffer["PROPERTIES"]["DIAMETR_1"]["VALUE"],
                            "SHIRINA_OBODA" => $arOffer["PROPERTIES"]["SHIRINA_OBODA"]["VALUE"],
                            "PCD" => $arOffer["PROPERTIES"]["PCD"]["VALUE"],
                            "ET" => $arOffer["PROPERTIES"]["ET"]["VALUE"]
                          ))?></a></td>
